class Login {
  ...
  constructor() {
    ...
    if (!localStorage.getItem("usersList")) {
      ...
      const usuarios = [];
      usuarios.push(
        RegistroEstudiantil.crearUsuario(
          "admin",
          "c0ntr4s3ñ4",
          "admin",
          "",
      ...
      usuarios.push(
        RegistroEstudiantil.crearEstudiante(
          "student",
          "c0ntr4s3ñ4",
          "Pepe",
          "Gonzalez",
      ...
      RegistroEstudiantil.guardarUsuarioStorage(
        RegistroEstudiantil.crearUsuario("admin")
      );
    }
    ...
    this.BTN_SUBMIT.addEventListener("click", (e) => {
      e.preventDefault();
      let validado = this.validarUsuario(
        this.INP_USERNAME.value,
        this.INP_PASSWORD.value
      );
      this.P_MSG_DISPLAY.innerHTML = validado.msg;
      this.P_MSG_DISPLAY.style.backgroundColor = validado.valido
        ? "green"
        : "red";
      ...
      if (validado.valido === true) {
        ...
        setTimeout(() => {
          window.location.href =
            "http://127.0.0.1:5500/modulos/materias/materias.html";
        }, 3000);
      }
    });
  }
    ...
    if (usuario && usuario.password === password) {
      return {
        ...
        usuario: {
          ...
          email: usuario.email,
          codCuatrimIni: usuario.codCuatrimIni,
          edad: usuario.edad,
        },
      };
    }
